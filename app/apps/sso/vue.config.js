...
let appDevProxyUrl = process.env.VUE_APP_DEV_PROXY_URL
if (!appDevProxyUrl) {
  appDevProxyUrl = ''
}

// dev7 for formal environment
// const api = 'http://10.20.0.74:31850'

// dev for test environment
const api = 'http://10.20.2.52:31850'
...
module.exports = {
  ...
  devServer: {
    ...
    hot: true,
    // proxy: appDevProxyUrl + process.env.VUE_APP_BASE_API,
    proxy: {
      '/prod-api': {
        target: api,
        pathRewrite: {
