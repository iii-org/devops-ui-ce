...
export const getVersionAuthInfo = () => request.get(`/v2/system_parameter/version_auth_info`)
export const updateVersionAuthInfo = (data) => request.patch(`/v2/system_parameter/version_auth_info`, data)

export const getKeycloakConfig = (data) => request.post(`/v2/system_parameter/keycloak/realm/config`, data)
export const updateKeycloakConfig = (data) => request.put(`/v2/system_parameter/keycloak/realm/config`, data)
