  ...
  <div>
    ...
    <el-card shadow="never">
      <el-form label-position="left" label-width="120px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item :label="$t('Release.releaseNote')" label-width="auto">
              <el-input
                v-model="note"
                class="w-full"
                type="textarea"
      ...
      <div class="el-alert el-alert--error is-light mb-3">
        <em class="el-alert__icon el-icon-warning" />
        <div class="el-alert__content">
          <span class="el-alert__title">{{ $t('Release.ReleaseWarning') }}</span>
        </div>
      </div>
