<template>
  <div class="app-container">
    <el-button
      ...
      @click.native="handleApplicationSetting()"
    >
    ...
    <div class="flex justify-between items-center">
      <el-col class="notification mr-1">
      ...
      <div>
        <el-button
          ...
          @click="handleRefresh"
        >
          <span v-if="!isMobile">{{ $t('general.Refresh') }}</span>
        </el-button>
      </div>
    </div>
    <ElTableResponsive
...
export default {
  ...
  methods: {
    ...
    handleApplicationSetting(applicationId = null) {
      this.$router.push({ name: 'ApplicationSetting', params: { applicationId }})
    },
    getActionText(value) {
