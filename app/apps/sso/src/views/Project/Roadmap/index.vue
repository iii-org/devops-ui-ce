<template>
  <el-row v-loading="listLoading" :element-loading-text="$t('Loading')" class="app-container">
    ...
    <el-divider />
    <el-row :gutter="10">
      <el-col :span="24" :class="isMobile ? 'mobile' : ''">
        <el-card id="list" class="card">
              ...
              <el-collapse-item v-for="version in versionList" :id="`version${version.id}`" :ref="`version${version.id}`" :key="version.id" :name="version.id">
                <template slot="title">
                  <div class="flex items-center">
                    ...
                    <div class="mr-7" :style="`width: ${isMobile ? '150px' : '700px'}`">
                ...
                <el-row v-loading="contentLoading" :gutter="12">
                  ...
                  <el-col :span="isMobile ? 24 : 16">
                    <WorkloadCard
                      ref="issuePriority"
                      :statistics-obj="version.workLoadData"
...
import { WorkloadCard } from '@shared/views/Plan/Overview/components'
