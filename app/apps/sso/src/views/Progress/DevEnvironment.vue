          ...
          >
            <div class="flex justify-between mb-2">
              ...
              <div style="min-width: fit-content;">
                ...
                >
                  <span v-if="!isMobile">{{ $t('general.Redeploy') }}</span>
                </el-button>
                <el-popconfirm
                ...
                >
                  <el-button
                    ...
                    plain
                  >
                    <span v-if="!isMobile">{{ $t('general.Delete') }}</span>
                  </el-button>
                </el-popconfirm>
              </div>
            </div>
                        ...
                        >
                          <div class="text-right">
                            <el-tag
                              ...
                              size="mini"
                              :effect="container.state === 'running' ? 'light' : 'dark'"
                              :color="container.state === 'running' ? runningStateColor : ''"
                            >
                              {{ container.state }}
                            </el-tag>
                          </div>
