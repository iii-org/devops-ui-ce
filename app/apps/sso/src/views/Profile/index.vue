    ...
    <el-card :class="isMobile ? 'mobile' : ''">
      ...
      >
        ...
        <el-tab-pane name="message">
          <span slot="label">
            <svg-icon v-if="isMobile" icon-class="notification-settings" class="text-2xl align-middle" />
            <span v-else>{{ $t('Profile.Notice') }}</span>
          </span>
          <Message
        ...
        <el-tab-pane :label="$t('Profile.ServerPassword')" name="server">
          <span slot="label">
            <em v-if="isMobile" class="ri-lock-password-line text-xl align-middle" />
            <span v-else>{{ $t('Profile.ServerPassword') }}</span>
          </span>
          <Server
