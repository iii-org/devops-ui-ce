...
export default {
  ...
  Notify: {
    ...
    pluginNameWarnNotifications: '分支名稱過長，爲確保 Pipeline 執行順利，請限縮 Git Project Name + Branch Name 在 40 字以內。',
  ...
  Issue: {
    ...
    IssueHasAssigneeWarning: '將狀態切換回「@:Issue.Active」將會移除目前的指派人員。您確定要繼續嗎？',
    ChildrenNotClosedWarning: '關閉此議題將同時關閉所有與其相關的未解決子議題。您確定要繼續嗎？',
    PackageRecord: '包版紀錄',
    NoImage: '沒有映像檔',
    ReleaseTime: '包版時間',
    SourceCode: '原始碼',
    ...
    DueDateWarning: '請先設置開始日期',
    DueDateAloneWarning: '結束日期不得單獨設置, 將一併清除結束日期, 是否繼續？',
    NextStep: '下一步>',
    detail: {
      message: {
  ...
  Plugin: {
    ...
    GenerateCIButton: '重新產生 DevOps CI 腳本 >',
  ...
  Profile: {
    ...
    ResetPassword: '重設密碼',
    DeviceVerification: '裝置驗證',
    EnableDeviceVerification: '啟用裝置驗證',
    DeviceVerificationDescription: '本服務可啓用裝置驗證和生物辨識驗證直接登入'
  },
  Project: {
    Project: '專案',
    Starred: '重點專案',
  ...
  SystemVersion: {
    ...
    Activating: '啟用中',
    Inactive: '未啟用',
    VerificationCompleted: '已驗證完成',
    ActivateBeforeUsing: '請先啟用再使用此功能',
    ActivationInformation: '啟用資訊',
  ...
  ProjectSettings: {
    ...
    DeleteTag: '刪除「{tagName}」? 尚有議題注意著此標籤，若刪除標籤會一併清除關聯，請確認是否刪除?',
  ...
  SystemConfigs: {
    ...
    GitLabExternalDescription: '出於安全考慮，III DevOps 僅啟用 Gitlab 內部訪問，但在 IP 模式下不受影響。',
    KeycloakTimeout: 'Keycloak 登入 Session 過期時間',
    KeycloakTimeoutDescription: '預設登入會話過期時間為30分鐘，該值可以以分鐘為單位進行設定。',
    UploadFileTypes: '檔案上傳類型設定',
    FileExtension: '副檔名',
    IncludesMimeType: '資料內已有{mimeType}',
    TypeBetween0And100: '請輸入介於 0 到 100 之間的數字。',
    LoginTimeDurationSetting: '登入時間長度設定',
    DurationTime: '時間長度',
    Minutes: '分鐘',
    DoNotExceed24Hours: '請不要超過24小時 (1440分鐘)'
  },
  Kanban: {
