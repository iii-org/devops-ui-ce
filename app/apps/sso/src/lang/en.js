...
export default {
  ...
  Notify: {
    ...
    pluginNameWarnNotifications:
        'The name of the branch is too long. To ensure the smooth execution of Pipeline, please limit Git Project Name + Branch Name within 40 words',
    pluginRepeatMessage:
    ...
    RedmineMailConfirmWarning:
      'Mail(SMTP) setting modification will be restarted to Redmine, which will cause the DEVOPS platform to stop the service for 5-8 minutes. If it is necessary to perform modification and restart the redmine?',
  ...
  Issue: {
    ...
    DueDateWarning: 'Please set the start date first',
    DueDateAloneWarning: 'The due date cannot be set individually, the due date will be cleared together, do you want to continue?',
    NextStep: 'Next Step>',
    detail: {
      message: {
  ...
  Plugin: {
    ...
    CustomEnvWarning: 'DevOps CI File is Missing ?!',
    CustomRecommendWarning: 'We recommend you to use the templates from this platform to ensure everything works properly.',
    GenerateCIButton: 'Generate DevOps CI File >',
    CustomRuleWarning: '* Regenerate CI file only available if the project’s created by our templates'
  },
  DevOps: {
    Id: 'Id',
    Phase: 'Phase',
  ...
  Profile: {
    ...
    EnableDeviceVerification: 'Enable Device Verification',
    DeviceVerificationDescription: 'This service allows enabling device verification and biometric authentication for direct login.'
  },
  Project: {
    Project: ' Project',
  ...
  SystemVersion: {
    ...
    ActivateBeforeUsing: 'Please activate before using this feature.',
  ...
  SystemConfigs: {
    ...
    GitLabExternalDescription: 'For security concern, III DevOps only enable Gitlab internal access. But will not be affected in the IP mode',
    KeycloakTimeout: 'Keycloak Login Session Expiration Time',
    KeycloakTimeoutDescription: 'Default login session expiration is 30 minutes, the value can be set by the unit of minute',
    ...
    LoginTimeDurationSetting: 'Login Time Duration Setting',
    DurationTime: 'Duration of time',
    Minutes: 'minutes',
    DoNotExceed24Hours: 'Please do not exceed 24 hours (1440 minutes)'
  },
  Kanban: {
