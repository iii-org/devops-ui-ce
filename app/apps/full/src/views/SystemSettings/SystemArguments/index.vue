<template>
  <div class="app-container">
    <el-tabs
      ...
      :stretch="isMobile"
    >
      <el-tab-pane name="secrets" class="linkTextColor">
        <span slot="label">
          <em v-if="isMobile" class="ri-spy-line text-xl align-middle" />
          <span v-else>{{ $t('System.Secrets') }}</span>
        </span>
        <SystemSecrets ref="secrets" />
      </el-tab-pane>
      <el-tab-pane name="registry">
        <span slot="label">
          <em v-if="isMobile" class="ri-draft-line text-xl align-middle" />
          <span v-else>{{ $t('System.Registry') }}</span>
        </span>
