...
import { IssueExpand, ContextMenu, Pagination, CancelRequest } from '@/mixins'
import { Status, Tracker, Priority } from '@/components/Issue'
...
export default {
  ...
  mixins: [IssueExpand, ContextMenu, Pagination, CancelRequest],
  props: {
    from: {
      type: String,
      default: 'assigned_to'
