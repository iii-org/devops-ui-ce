          ...
          <template slot="label">
            ...
            <span v-if="isIssueStatusChange('start_date')">
              ...
              <el-button
                ...
                size="mini"
                icon="el-icon-close"
                @click="handleCancelCloseIssue('start_date')"
              />
            </span>
          </template>
          <el-date-picker
          ...
          <template slot="label">
            ...
            <span v-if="isIssueStatusChange('due_date')">
              ...
              <el-button
                ...
                size="mini"
                icon="el-icon-close"
                @click="handleCancelCloseIssue('due_date')"
              />
            </span>
          </template>
          <el-date-picker
...
import SubIssueDialog from '@/views/Project/IssueDetail/components/SubIssueDialog'
  ...
  methods: {
    ...
    async updateSelect(type, forceClose = false) {
      this.$refs.form.validate(async(valid) => {
        if (!valid) return
        await this.updateIssue(type, forceClose)
      })
    },
