    ...
    <el-card>
      <el-steps :active="stepActive" finish-status="success" align-center>
        <el-step :title="$t('Release.IssueVersion')">
          <template v-if="stepActive === 0 && !isMobile" slot="description">
            <span>
        ...
        <el-step :title="$t('Release.ImageVersion')">
          <template v-if="stepActive === 1 && !isMobile" slot="description">
            <span>
        ...
        <el-step :title="$t('Release.ReleaseVersion')">
          <template v-if="stepActive === 2 && !isMobile" slot="description">
            <span>
