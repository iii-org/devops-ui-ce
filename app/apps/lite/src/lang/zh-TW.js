...
export default {
  ...
  errorMessage: {
    ...
    1017: '專案被禁用。',
    1018: '父議題尚未關連，{tracker_name} 的議題修改或新增都須含有父議題。',
    1019: `專案 {project_name} Gitlab ci yaml 檔案格式錯誤: {error_message}。`,
    1020: '在 Gitlab 找不到名稱爲 {tag} 的 tag。',
    1021: '在 Gitlab 找不到名稱爲 {branch} 的 branch。',
    1022: '找不到 id 爲 {service_uuid} 的實證環境資源。',
    1023: '找不到 id 爲 {service_uuid} 實證環境資源的檔案 {file_path}。',
    1024: '找不到實證環境資源的範本 {template}。',
    1025: `專案擴充服務建立 ({project_id}) 因範本 {template} 失敗。錯誤訊息：服務已超出專案配額，請刪除未使用的服務並重試。`,
    1026: `專案擴充服務建立 ({project_id}) 因範本 {template} 失敗。錯誤訊息：模板（Helm圖表）解析錯誤，請聯絡管理員更新範本。`,
    1027: `專案擴充服務建立 ({project_id}) 因範本 {template} 失敗。錯誤訊息：意外錯誤，請聯絡管理員。`,
    1029: '名爲 {pid} 的 pid 已經存在。',
    1030: '更新專案實證環境資源 {server_name} 失敗: {error_msg}。',
    1031: '刪除專案實證環境資源 {server_name} 失敗: {error_msg}。',
    1032: '找不到 id 爲 {uuid} 的實證環境資源。',
    1033: '名爲 {pid} 的 pid 不存在。',
    1034: '專案釋出版本 {version} 是無效的，因為並沒有支援中文字體。',
    ...
    2007: '使用者 {user_id} 為專案 {project_id} 之專案經理，不可刪除。',
    2008: '使用者 {user_id} 來自 AD，一般使用者無法編輯。',
    2009: '使用者 {user_id} 有在專案內，無法變更其角色或是刪除該使用者。',
    2011: '部署主機 {server_name} 無法被存取。',
    2012: '部署主機 {server_name} 無法被新增。',
    2013: '部署主機 {server_name} 無法被更新。',
    2014: '部署主機無法被刪除。',
    2015: 'Registry {registry_id} 無法被存取。',
    2016: 'Registry {registry_name} 無法被新增。',
    2017: 'Registry {registry_name} 無法被更新。',
    2018: 'Registry 無法被刪除。',
    2019: '部署服務 {application_name} 無法被新增。',
    2020: '部署服務無法被存取。',
    2021: '部署服務無法被更新。',
    2022: '部署服務 {application_name} 主機已達到重試次數限制。',
    2023: '部署服務 {application_id} 無法被刪除。',
    2024: '部署主機 {cluster_id} 不存在或無訪問權限。',
    2025: 'Register {registries_id} 不存在或無訪問權限。',
    2050: '看板名稱 {name} 已存在。',
    2051: '項目名稱 {name} 已存在。',
    2052: '項目名稱 {item_id} 已存在。',
    2053: '議題 {issue_id} 已不在項目 {item_id} 內。',
    3001: '您的角色沒有權限進行此項操作。',
    3002: '您需要屬於此專案才能進行這項操作。',
    3003: '您不被允許存取其他使用者的資料。',
    3004: '僅專案經理才可設置，請洽專案經理協助。',
    3007: '服務 {service} 部署失敗，請洽 III DevSecOps 服務團隊。',
    3008: '本環境尚未部署服務套件({service})。',
    3101: '未提供授權標頭，請確認您已登入並嘗試重新請求。',
    3102: '無效的存取 token。',
    3103: '無法在資料庫中找到對應 token {token} 的 {user} 用戶資訊。',
    3104: '請求來源 {host} 無效，請確認您是從一個合法且被允許的網域 {user_agent} 發起請求。',
    3201: '版本授權密鑰格式不正確。',
    3202: '版本授權密鑰已過期或密碼不正確。',
    4001: 'ID 爲 {issue_id} 之議題不存在。',
    ...
    5003: '用戶 {user_id} 不屬於此 gitlab 範本專案 {template_repository_id} 的成員。',
    5101: '找不到擴充範本 {template_file_path}。',
    5102: '擴充範本 {template_file_path} 是空的。',
    7001: '此錯誤不含詳細資訊。',
    7002: '參數 {arg} 輸入錯誤。',
    7003: '找不到指定的資源。',
    7004: '找不到指定的網址，請確認您輸入了正確的網址。',
    7005: '{object} 的最大數量為 {num}。',
    7006: '當議題有子議題時，參數 {arg} 不能被調整。',
    7007: `參數 {arg} 需要以 'ghp_'做開為開頭。`,
    7008: '該檔案 {file_name} 沒有在路徑 {path} 中。',
    7009: '根據 google 的政策, 帳號 {account} 需要申請 app password 來使用 SMTP 的服務。',
    7010: 'SMTP server 回報錯誤, 請確認你的服務, 阜號, 帳號或是密碼是正確的。',
    8001: '{service_name} 回報錯誤: {response}。',
    8101: '父議題設定異常，請確認設定之議題非為本議題之子議題或關係議題。',
    8201: '{tag} 已經存在這個 Harbor 的 repository {repo_name} 中。',
    8202: '不能打 tag 到 Harbor 的 repository {repo_name} 中，因為他沒有映象檔。',
    8601: 'Pod {pod_names} 已不在 k8s 的服務之中。',
    8901: '插件軟體 {plugin_name} 的設定是關閉的狀態。',
    8902: '插件服務 {plugin_name} 目前沒有存活。',
    9001: '內部錯誤：{type}: {exception}。',
    9002: '出現無效的代碼路徑: {message}。',
    9003: '發生未被預期的資料庫錯誤：{message}。',
    9999: '發生未知錯誤。',
    20001: 'Token 是無效的。',
    20002: 'Token 並不屬於這個 account。',
