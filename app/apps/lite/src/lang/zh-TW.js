...
export default {
  ...
  Issue: {
    ...
    ConfirmCloseIssueWithSub: '此議題「{issueName}」尚有子議題，請再次確認是否真的要"關閉"此議題，同時一併"關閉"下列子議題？',
    ConfirmDeleteIssueWithSub: '此議題「{issueName}」尚有子議題，請再次確認是否真的要"刪除"此議題，同時一併"刪除"下列子議題？',
