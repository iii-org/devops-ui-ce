...
export const getMyProjectSimpleList = () => request.get(`/v2/project/simple/list`)
...
export const getIssueByTagId = (project_id, tag_id) =>
  request.get(`/v2/project/${project_id}/issues?only_superproject_issues=false&status_id=open&tags=${tag_id}`)
